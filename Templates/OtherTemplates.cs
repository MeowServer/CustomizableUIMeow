        ...
        public static class SpectatorUITools
        {
            ...
            public static string GetRespawnTimer()
            {
                ...
                if (Respawn.IsSpawning)
                {
                    ...
                    .Replace("{RespawnTeam}", Config.UIPluginConfig.instance.GeneralConfig.RespawnTeamDictionary[Respawn.NextKnownTeam]);//Team
                }
                else
                {
            ...
            public static string GetWarheadStatus()
            {
                ...
                {
                    message = template
                    .Replace("{WarheadStatus}", Config.UIPluginConfig.instance.GeneralConfig.WarheadStatusDictionary[Warhead.Status])
            ...
            private static TimeSpan timeToRefresh = TimeSpan.FromSeconds(Config.UIPluginConfig.instance.SpectatorTemplateConfig.HintDisplayInterval);
            public static string GetHint()
            {
                ...
                if (TimeInterval > timeToRefresh)
                {
                    ...
                    if (hintIndex == Config.UIPluginConfig.instance.SpectatorTemplateConfig.Hints.Count() - 1)
                    {
                        hintIndex = 0;
                    }
                    else
                ...
                return Config.UIPluginConfig.instance.SpectatorTemplateConfig.Hints[hintIndex];
            }
        }
    }
}
